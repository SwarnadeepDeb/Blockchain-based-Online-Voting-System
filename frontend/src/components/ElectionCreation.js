...
//     if (!voteStartDate) {
//       showError(
//         document.getElementById("votestartDate"),
//         "Vote start date is required."
//       );
//       isValid = false;
//     }
...
//     if (!voteEndDate) {
//       showError(
//         document.getElementById("voteendDate"),
//         "Vote end date is required."
//       );
//       isValid = false;
//     }
...
//       showError(
//         document.getElementById("voteendDate"),
//         "Vote end date must be after vote start date."
//       );
//       isValid = false;
//     }
...
//       showError(
//         document.getElementById("votestartDate"),
//         "Vote start date must be after registration end date."
//       );
//       isValid = false;
//     }
...
//         <h2 className="title">Create Election</h2>
//         <form id="eventForm">
...
//           </div>
//           <div className="form-group">
//             <label className="label" htmlFor="votestartDate">
//               Vote Start Date and Time:
//             </label>
//             <input
//               className="input"
//               type="datetime-local"
...
//           </div>
//           <div className="form-group">
//             <label className="label" htmlFor="voteendDate">
//               Vote End Date and Time:
//             </label>
//             <input
//               className="input"
//               type="datetime-local"
...
function ElectionCreation({ state, elections, updateElections }) {
  ...
  const [showAlert, setShowAlert] = useState(false); // To toggle the alert visibility
  ...
  async function handleSubmit(event) {
    ...
    try {
      ...
      // Show success alert
      showAlertWithMessage("Election created successfully!","success");
    } catch (error) {
      console.error("Error creating election:", error);
      showAlertWithMessage("An error occurred while creating the election.","error");
    }
  }
  ...
  const showAlertWithMessage = (message,type) => {
    ...
    setAlertType(type)
    setShowAlert(true);
    setTimeout(() => {setShowAlert(false);setAlertMessage("")}, 3000); // Automatically hide alert after 3 seconds
  };
  ...
  return (
    <div className="form-container">
      ...
      {showAlert && <CustomAlert message={alertMessage} onClose={closeAlert}type={alertType} />}
    </div>
  );
}
